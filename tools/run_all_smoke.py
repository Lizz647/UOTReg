...
PLAN = [
    ...
    ("notebooks/simulation_outliers/run_outliers.ipynb", "torch", None, None),
    ("notebooks/simulation_outliers/outlier_figs.ipynb", "torch", None, None),
    ("notebooks/simulation_divergence/divergence_outliers.ipynb", "torch", None, None),
    ("notebooks/simulation_divergence/divergence_realdata.ipynb", "torch", None, None),
    ("notebooks/simulation_divergence/divergence_figs.ipynb", "torch", None, None),
    ("notebooks/simulation_batcheffect/bifurcation_estimate.ipynb", "torch", {"SAVE": 1}, None),
    ("notebooks/simulation_batcheffect/bifurcation_trajectories.ipynb", "torch", {"SAVE": 1}, None),
    ("notebooks/simulation_batcheffect/bifurcation_figs.ipynb", "torch", None, None),
    ("notebooks/simulation_batcheffect_reverse/reverse_estimate.ipynb", "torch", {"SAVE": 1}, None),
    ("notebooks/simulation_batcheffect_reverse/reverse_trajectories.ipynb", "torch", {"SAVE": 1}, None),
    ("notebooks/simulation_batcheffect_reverse/reverse_figs.ipynb", "torch", None, None),
    ("notebooks/realdata_loo/loo_embryoid.ipynb", "torch", None, None),
    ("notebooks/realdata_loo/loo_statefate.ipynb", "torch", None, None),
    ("notebooks/realdata_loo/loo_figs.ipynb", "torch", None, None),
    ("notebooks/realdata_analysis/estimate_and_trajectories.ipynb", "torch", None, None),
    ("notebooks/realdata_analysis/estimate_and_trajectories.ipynb", "torch",
     {"DATASET": "statefate"}, None),
    ("notebooks/realdata_analysis/fates_and_markers.ipynb", "torch", None, None),
    ("notebooks/realdata_analysis/fates_and_markers.ipynb", "torch", {"DATASET": "statefate"}, None),
    ("notebooks/realdata_analysis/figures.ipynb", "torch", None, None),
    ("notebooks/realdata_analysis/figures.ipynb", "torch", {"DATASET": "statefate"}, NO_H5AD),
    ("notebooks/realdata_analysis/cross_dimension.ipynb", "torch", None, None),
]
